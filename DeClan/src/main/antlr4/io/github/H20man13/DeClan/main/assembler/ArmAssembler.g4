...
mlalInstr : MULTIPLY_AND_ACUMULATE_LONG REG COMMA REG COMMA REG COMMA REG;
...
mullInstr : MULTIPLY_LONG REG COMMA REG COMMA REG COMMA REG;
...
MULTIPLY_AND_ACUMULATE_LONG: (U | S) MLAL CONDITION_CODE? S?;
MRS_INSTR: MRS CONDITION_CODE?;
MSR_INSTR: MSR CONDITION_CODE?; 
MULTIPLY: MUL CONDITION_CODE? S?;
MULTIPLY_LONG: (S | U) MULL CONDITION_CODE? S?;
...
fragment MSR : M S R;
fragment MUL : M U L;
fragment MULL : M U L L;
fragment MLAL : M L A L;
fragment MVN : M V N;
fragment ORR : O R R;
fragment RSB : R S B;
fragment RSC : R S C;
