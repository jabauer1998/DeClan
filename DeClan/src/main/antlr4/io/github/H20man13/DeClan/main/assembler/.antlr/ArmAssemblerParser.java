...
public class ArmAssemblerParser extends Parser {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"number", "realNumber", "address", "preIndexedAddressing", "postIndexedAddressing", 
			"shiftName", "psr", "psrf"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "ASL", "LSL", "LSR", "ASR", "ROR", "RPX", "DOT_WORD", "DOT_BYTE", 
			"BRANCH", "BRANCH_WITH_LINK", "BRANCH_WITH_EXCHANGE", "LOAD_MEMORY", 
			"LOAD_REGISTER", "LOAD_SIGNED_REGISTER", "MULTIPLY_AND_ACUMULATE", "MRS_INSTR", 
			"MSR_INSTR", "MULTIPLY", "STORE_MEMORY", "STORE_REGISTER", "STORE_SIGNED_REGISTER", 
			...
			"TEST_BITS", "TEST_EQUALITY", "COMPARE", "COMPARE_NEGATIVE", "MOVE", 
			"MOVE_NEGATIVE", "STOP", "REG", "LABEL", "IDENT", "NUMBER", "CPSR", "CPSR_ALL", 
			"CPSR_FLG", "SPSR", "SPSR_ALL", "SPSR_FLG", "EXP", "WS", "COMMA", "LCURL", 
			"RCURL", "LBRACK", "RBRACK", "REQ", "RNE", "RLE", "RLT", "RGE", "RGT", 
			"TIMES", "MINUS", "PLUS", "MOD", "DIV", "LSHIFT", "RSHIFT", "BAND", "BOR", 
			"BXOR", "LAND", "LOR", "HASH", "COLON", "PERIOD"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 6597069766528L) != 0) );
			}
		}
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 121L) != 0)) {
				{
				setState(432);
				_la = _input.LA(1);
				if ( !(((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 121L) != 0)) ) {
	...
	public static final String _serializedATN =
		...
		"-\u0001-\u0001-\u0003-\u01a4\b-\u0001.\u0001.\u0001.\u0003.\u01a9\b.\u0001"+
		"/\u0001/\u0001/\u0003/\u01ae\b/\u00010\u00010\u00010\u00030\u01b3\b0\u0001"+
		"1\u00031\u01b6\b1\u00011\u00011\u00012\u00012\u00012\u00032\u01bd\b2\u0001"+
		"3\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u0001"+
		"3\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u0001"+
		"3\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u0001"+
		"3\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00033\u01e6"+
		"\b3\u00014\u00014\u00015\u00015\u00015\u00015\u00016\u00016\u00016\u0003"+
		"6\u01f1\b6\u00017\u00017\u00017\u00017\u00017\u00017\u00017\u00017\u0001"+
		"7\u00037\u01fc\b7\u00017\u00017\u00017\u00017\u00037\u0202\b7\u00017\u0001"+
		"7\u00017\u00037\u0207\b7\u00017\u00017\u00037\u020b\b7\u00037\u020d\b"+
		"7\u00018\u00018\u00018\u00018\u00018\u00018\u00018\u00018\u00018\u0001"+
		"8\u00038\u0219\b8\u00018\u00018\u00018\u00038\u021e\b8\u00038\u0220\b"+
		"8\u00019\u00019\u0001:\u0001:\u0001;\u0001;\u0001;\u0000\u0000<\u0000"+
		"\u0002\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018\u001a\u001c"+
