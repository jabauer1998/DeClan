...
import declan.middleware.analysis.iterative.AnticipatedExpressionsAnalysis;
import declan.middleware.analysis.iterative.AvailableExpressionsAnalysis;
import declan.middleware.analysis.iterative.ConstantPropogationAnalysis;
import declan.middleware.analysis.iterative.DominatorAnalysis;
import declan.middleware.analysis.iterative.ExpectedConstantAnalysis;
import declan.middleware.analysis.iterative.LiveVariableAnalysis;
import declan.middleware.analysis.iterative.MovedConstantAnalysis;
import declan.middleware.analysis.iterative.PostponableExpressionsAnalysis;
import declan.middleware.analysis.iterative.ReachingDefinitionsAnalysis;
import declan.middleware.analysis.iterative.SavedExpressionAnalysis;
import declan.middleware.analysis.iterative.UsedExpressionAnalysis;
import declan.middleware.dag.DagGraph;
import declan.middleware.dag.DagIgnoredInstruction;
...
import declan.middleware.dfst.BackEdgeLoop;
import declan.middleware.dfst.DepthFirstMetaEdge;
...
import declan.utils.exception.OptimizerException;
import declan.utils.flow.BasicBlock;
import declan.utils.flow.BlockNode;
import declan.utils.flow.EntryNode;
import declan.utils.flow.ExitNode;
...
import declan.middleware.region.LoopBodyRegion;
import declan.middleware.region.LoopRegion;
...
import declan.middleware.region.BaseRegion;
import declan.middleware.region.BlockRegion;
...
public class MyOptimizer {
    ...
    public void buildFlowGraph() {
        ...
        */
        ...
        Map<String, BlockNode> sectionEntryPoints = findSectionEntryPoints(nodeList);
        linkUpSections(nodeList, sectionExitPoints, sectionEntryPoints);
