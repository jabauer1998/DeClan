...
public class DepthFirstSpanningTree {
        ...
        public Map<Tuple<FlowGraphNode, FlowGraphNode>, BackEdgeLoop> identifyLoops(){
                ...
                for(int i = 0; i < numBackEdges; i++){
                        ...
                        List<BlockNode> reversedLoopList = new ArrayList<>(loopList);
                        Collections.reverse(reversedLoopList);
                        toRet.put(newEdge, new BackEdgeLoop(reversedLoopList));
                }
        ...
        public String toString() {
                ...
                List<Integer> depthFirstOrderTraversal = new ArrayList<>(postOrderTraversalResult);
                Collections.reverse(depthFirstOrderTraversal);
        ...
        public List<RootDfstNode> getDepthFirstOrderSequence(){
                ...
                List<RootDfstNode> reversed = new ArrayList<>(postOrdering);
