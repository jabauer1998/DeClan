    ...
    protected boolean changesHaveOccuredOnOutputs(MapType cached){
        ...
        /*} else {
                ...
                for(AnalysisType key : keys){
                    ...
                    if(actualData.size() != cachedData.size()) {
                        Utils.appendToFile("./tmp/AnalysisCacheLog.txt", "For " + key + " actual data size not equal to cache data size!!!\r\n");
                        Utils.appendToFile("./tmp/AnalysisCacheLog.txt", "Actual data size: " + actualData.size() + "\r\n");
                        Utils.appendToFile("./tmp/AnalysisCacheLog.txt", "Actual data: " + actualData.toString() + "\r\n");
                        Utils.appendToFile("./tmp/AnalysisCacheLog.txt", "Cached data size: " + cachedData.size() + "\r\n");
