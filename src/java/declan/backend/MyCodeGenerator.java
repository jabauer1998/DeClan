...
import declan.middleware.analysis.iterative.RegisterAllocatorAnalysis;
import declan.backend.arm.ArmCodeGenerator;
import declan.utils.pat.P;
import declan.utils.pat.Pattern;
import declan.utils.symboltable.entry.VariableEntry;
import declan.utils.Utils;
import declan.backend.arm.descriptor.ArmAddressOffsets;
import declan.backend.arm.descriptor.ArmRegisterResult;
import declan.backend.arm.ArmCodeGenerator.VariableLength;
import declan.frontend.ast.VariableDeclaration;
import declan.utils.exception.CodeGeneratorException;
...
public class MyCodeGenerator {
        ...
        public MyCodeGenerator(String outputFile, Lib program, MyOptimizer opt, ErrorLog errLog, Config cfg)
                        throws IOException {
        ...
        private String loadVariableToReg(IdentExp exp, ICode.Type type, ArmRegisterResult pre, ArmRegisterResult res)
                        throws IOException {
        ...
        private String genUnaryOp(String label, UnExp.Operator op, String rightReg, ArmRegisterResult res)
                        throws Exception {
        ...
        private String genBinaryOp(String label, String leftReg, BinExp.Operator op, String rightReg, ArmRegisterResult res)
                        throws Exception {
        ...
        private String genExpression(Exp expression, ICode.Type returnType, ArmRegisterResult pre, ArmRegisterResult res)
                        throws Exception {
        ...
        private void initCallWithReturn0() {
                codeGenFunctions.put(Pattern.callWithReturn0, new Callable<Void>() {
                        ...
                        public Void call() throws Exception {
                                ...
                                cGen.addInstruction("STRB " + temp + ", [R13, #-"
                                                + offset.findOffset(returnPlacement.label, returnPlacement.type) + ']');
        ...
        private void initCallWithReturn1() {
                codeGenFunctions.put(Pattern.callWithReturn1, new Callable<Void>() {
                        ...
                        public Void call() throws Exception {
                                ...
                                // Now to load the Return value from the Stack
                                String temp = loadVariableToReg((IdentExp) returnPlacement.value, returnPlacement.getType(), pre2,
                                                res2);
                                cGen.addInstruction("STRB " + temp + ", [R13, #-"
                                                + offset.findOffset(returnPlacement.place, returnPlacement.getType()) + ']');
        ...
        private void initCallWithReturn2() {
                codeGenFunctions.put(Pattern.callWithReturn2, new Callable<Void>() {
                        ...
                        public Void call() throws Exception {
                                ...
                                cGen.addInstruction("STR " + temp + ", [R13, #-"
                                                + offset.findOffset(returnPlacement.label, returnPlacement.type) + ']');
                ...
                codeGenFunctions.put(Pattern.bool0, new Callable<Void>() {
                        ...
                        public Void call() throws Exception {
                                ...
                                if (assignICode.scope == ICode.Scope.GLOBAL) {
                                        ...
                                        errorLog.add("Error pattern " + icode.toString() + " must be of type global", new Position(i, i));
                                }
                ...
                codeGenFunctions.put(Pattern.int0, new Callable<Void>() {
                        ...
                        public Void call() throws Exception {
                                ...
                                if (assignICode.scope == ICode.Scope.GLOBAL) {
                                        ...
                                        errorLog.add("Error cant assign constant to non global value " + icode.toString(), new Position(i, i));
                                }
                ...
                codeGenFunctions.put(Pattern.real0, new Callable<Void>() {
                        ...
                        public Void call() throws Exception {
                                ...
                                if (assignICode.scope == ICode.Scope.GLOBAL) {
                                        ...
                                        errorLog.add("Error cant assign constant to non global value in " + icode.toString(), new Position(i, i));
                                }
                ...
                codeGenFunctions.put(Pattern.str0, new Callable<Void>() {
                        ...
                        public Void call() throws Exception {
                                ...
                                if (assignICode.scope == ICode.Scope.GLOBAL) {
                                        ...
                                        errorLog.add("Cant assign non global to constant in " + icode.toString(), new Position(i, 0));
                                }
        ...
        private void initProcLabel0() {
                codeGenFunctions.put(Pattern.procLabel0, new Callable<Void>() {
                        ...
                        public Void call() throws Exception {
                                ...
                                if (intermediateCode.containsEntry(labelICode.label, SymEntry.INTERNAL | SymEntry.RETURN,
                                                SymbolSearchStrategy.FIND_VIA_FUNCTION_NAME)) {
                                        VarSymEntry entry = intermediateCode.getVariableData(labelICode.label,
                                                        SymEntry.INTERNAL | SymEntry.RETURN, SymbolSearchStrategy.FIND_VIA_FUNCTION_NAME);
                                ...
                                while (intermediateCode.containsEntry(labelICode.label, paramNum, SymEntry.INTERNAL | SymEntry.PARAM)) {
                                        VarSymEntry entry = intermediateCode.getVariableData(labelICode.label, paramNum,
                                                        SymEntry.INTERNAL | SymEntry.PARAM);
                                        offset.pushAddress(entry.icodePlace, entry.codeType);
                                        paramNum++;
                                }
                                ...
                                while (index < instruction.length()) {
                                        ...
                                        case SPECIFIER:
                                                if (Character.toLowerCase(letterAtIndex) == 'a') {
                                                        ...
                                                        index++;
                                                        continue;
                                                } else if (Character.toLowerCase(letterAtIndex) == 'u'
                                                                || Character.toLowerCase(letterAtIndex) == 'd') {
                                                        index++;
                                                        continue;
                                                } else {
